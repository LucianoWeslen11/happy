...
// Estilos
import '../styles/views/CreateOrphanage.css';
...
export default function CreateOrphanage() {
  ...
  function hadleSelectImages(event: ChangeEvent<HTMLInputElement>) {
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple onChange={hadleSelectImages} type="file" id="image[]" />
            </div>
          </fieldset>
